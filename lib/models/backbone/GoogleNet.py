...
class GoogleNet(nn.Sequential):
    ...
    def forward(self, x):
        # N x 3 x 127 x 127    N x 3 x 255 x 255
        x = self.Conv2d_1a_3x3(x)
        # N x 32 x 63 x 63    N x 32 x 127 x 127
        x = self.Conv2d_2a_3x3(x)
        # N x 32 x 61 x 61    N x 32 x 125 x 125
        x = self.Conv2d_2b_3x3(x)
        # N x 64 x 61 x 61    N x 64 x 125 x 125
        x = F.max_pool2d(x, kernel_size=3, stride=2)
        # N x 64 x 30 x 30    N x 64 x 62 x 62
        x = self.Conv2d_3b_1x1(x)
        # N x 80 x 30 x 30    N x 80 x 62 x 62
        x = self.Conv2d_4a_3x3(x)
        # N x 192 x 28 x 28    N x 192 x 60 x 60
        x = self.Mixed_5b(x)
        # N x 256 x 28 x 28    N x 256 x 60 x 60
        x = self.Mixed_5c(x)
        # N x 288 x 28 x 28    N x 288 x 60 x 60
        x = self.Mixed_5d(x)
        # N x 288 x 28 x 28    N x 288 x 60 x 60
        x = self.Mixed_6a(x)
        # N x 768 x 13 x 13    N x 768 x 29 x 29
        x = self.Mixed_6b(x)
        # N x 768 x 13 x 13    N x 768 x 29 x 29
        x = self.Mixed_6c(x)
        # N x 768 x 13 x 13    N x 768 x 29 x 29
